...
const CounterfactualValidation = ({ visible }: { visible: any }) => {
    return (
        <motion.div style={{ opacity: visible }} className="absolute inset-0 z-30 flex items-center justify-center px-6 md:px-10 py-10 pointer-events-none">
            <div className="w-full max-w-6xl rounded-[32px] border border-white/10 bg-black/80 dark:bg-black/80 backdrop-blur-2xl shadow-2xl p-6 md:p-10 pointer-events-auto">
                <div className="flex items-center justify-center gap-2 text-[10px] md:text-xs font-bold uppercase tracking-[0.25em] text-zinc-500 mb-4"><ShieldCheck className="h-3.5 w-3.5" /> VERITA / 10 · COUNTERFACTUAL VALIDATION</div>
